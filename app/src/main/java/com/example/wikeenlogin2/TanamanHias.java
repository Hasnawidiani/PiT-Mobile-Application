...
public class TanamanHias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tanaman_hias);
        ...
        //Kol
        ImageView kolImageView = findViewById(R.id.kol);
        kolImageView.setOnClickListener(view -> moveTo(Kol.class));
        //Escarole
        ImageView escaroleImageView = findViewById(R.id.escarole);
        escaroleImageView.setOnClickListener(view -> moveTo(Escarole.class));
    ...
    private void moveTo(Class<?> destinationClass) {
        Intent intent = new Intent(TanamanHias.this, destinationClass);
