...
public class Selatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selatan);
        ...
        //Articok
        ImageView articokImageView = findViewById(R.id.articok);
       articokImageView.setOnClickListener(view -> moveTo(Articok.class));
        //Kubis
       ...
       terongImageView.setOnClickListener(view -> moveTo(Terong.class));
        ...
        kemangiImageView.setOnClickListener(view -> moveTo(Kemangi.class));
        //BawangBatak
        ImageView bawangbatakImageView = findViewById(R.id.bawangbatak);
       bawangbatakImageView.setOnClickListener(view -> moveTo(BawangBatak.class));
        //SeladaHijau
      ...
      bitmerahImageView.setOnClickListener(view -> moveTo(Bit.class));
        ...
        //Koriander
        ImageView korianderImageView = findViewById(R.id.koriander);
        korianderImageView.setOnClickListener(view -> moveTo(Koriander.class));
    ...
    private void moveTo(Class<?> destinationClass) {
        Intent intent = new Intent(Selatan.this, destinationClass);
